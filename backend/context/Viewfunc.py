...
ViewFuncs = {
    ...
    '/api/page/info': UserController.get_userpage,
    '/api/page/notes': NoteController.get_page_notes,
    '/api/page/setalias': UserController.set_page_alias,
    '/api/page/setflag': UserController.set_page_flag
}
